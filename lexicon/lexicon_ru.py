...
– тесты по грамматике\n
Можешь включить напоминания, и я буду напоминать тебе заниматься😉
⬇️В меню слева внизу ты можешь перезапустить бота, выйти в главное меню, 
...
"""
    ...
    TEST_RULES = """Правила простые:\nЯ пишу предложение на английском с пробелом, а ты должен написать, что нужно вставить вместо этого пробела\n
